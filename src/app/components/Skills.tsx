...
const Skills = () => {
  return (
    ...
    <div className="grid lg:grid-cols-3 lg:grid-rows-2 grid-cols-3 sm:grid sm:grid-cols-10 sm:grid-rows-2  text-center xl:gap-x-0  text-purple-500 lg:ml-36 px-4 lg:gap-1 ">
        ...
        <div className="text-6xl group-hover:text-accent  mb-11 border-2 w-20 border-purple-300 dark:border-purple-300 bg-purple-100   h-20 rounded-full  pt-2 pl-2"> <FaReact /></div>
        <div className="text-6xl group-hover:text-accent  mb-11 border-2 w-20 border-purple-300 dark:border-purple-300 bg-purple-100   h-20 rounded-full  pt-2 pl-2"> <FaFigma /></div>
          </div>
