  ...
  return (
    <div>
      <footer className=" bg-purple-600 body-font ">
        <div className="container h-auto px-2 py-2 mx-auto flex items-center sm:flex-row flex-col">
          <a className="flex title-font font-medium items-center md:justify-start justify-center text-white font-serif">
            <Image
              src={logoo}
              alt="ok"
              className="w-10 h-10 rounded-full bg-black-900"
            />
          ...
          <span className="inline-flex mt-3 sm:ml-auto sm:mt-0 justify-center sm:justify-start">
            <Link
              ...
              className="text-gray-800 text-2xl hover:text-pink-600"
            >
              <RiInstagramFill />
            </Link>
            ...
            <Link
              ...
              className="ml-4 text-gray-800  text-2xl hover:text-blue-800"
            >
              <SiFacebook />
            </Link>
            ...
            <Link
              ...
              className="ml-4 text-gray-800 text-2xl hover:text-blue-900"
            >
              <FaLinkedin />
            </Link>
          </span>
